...
//	private JTextField textFieldInvID;
	...
	private JLabel lblNailsInventory;
	private JTextField textFieldInvID;
	...
	private void initialize() {
		...
		comboboxTools.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
					String query = " select * from DiffNails where ID=?";
					PreparedStatement pst = connection.prepareStatement(query);
		...
		btnSave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
					String query = "insert into DiffNails (Type,Quantity,Location) values (?,?,?)";
					PreparedStatement pst = connection.prepareStatement(query);
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{	
					String query = "Update DiffNails set ID = '"+textFieldInvID.getText()+"', Type = '"+textFieldType.getText() + "', Quantity = '"+textFieldAmount.getText()+"', Location = '"+textFieldPrice.getText()+"' where ID = '"+textFieldInvID.getText() + "' ";
					PreparedStatement pst = connection.prepareStatement(query);
					pst.execute();
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
					String query = "delete from DiffNails where ID = '"+comboboxTools.getToolTipText()+"' ";
					PreparedStatement pst = connection.prepareStatement(query);
		...
		btnLoad.setBounds(274, 13, 110, 27);
	...
	tableInv.addMouseListener(new MouseAdapter() {
		...
		public void mouseClicked(MouseEvent e) {
			try{
				...
				String query = " select * from DiffNails where ID='"+Name_+"' ";
				PreparedStatement pst = connection.prepareStatement(query);
	...
	lblNailsInventory = new JLabel("Nails Inventory:");
	lblNailsInventory.setFont(new Font("Tahoma", Font.PLAIN, 20));
	lblNailsInventory.setBounds(12, 18, 234, 36);
	frame.getContentPane().add(lblNailsInventory);
	
	textFieldInvID = new JTextField();
	textFieldInvID.setColumns(10);
	textFieldInvID.setBounds(57, 87, 61, 22);
